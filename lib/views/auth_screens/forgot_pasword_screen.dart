            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 2.h),
                    customTextFeild('Email Address', 'yourname@gmail.com', 'assets/png/email_logo.png', false, controller: controller.forgotEmailField,
                    ...
                    customButton("Continue",color: buttonPinkColor,fontweight: FontWeight.w700,fontsize: 16.sp,textColor: whiteColor,ontap: (){
                      if (forgotKey.currentState!.validate()){
                        controller.forgotEmailVerification(context);
                      }
                    }),
